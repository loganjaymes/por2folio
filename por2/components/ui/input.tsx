  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-blue-300 focus-visible:ring-blue-300/50 focus-visible:ring-[2px] dark:focus-visible:border-slate-300 dark:focus-visible:ring-slate-300/50",
